...
# DejaVu Serif Bold (titles, hung folio, sub-headings). The bold-italic
# variant carries the "editorial flourish" — page-indicator hung folio,
...
# is required for the *Italic.ttf file.
